                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="discount_value" id="discount_value" class="form-control" 
                                                            placeholder="Enter Discount Value" step="0.01" value="{{ old('discount_value') }}" required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="discount_code" id="discount_code" class="form-control" 
                                                            placeholder="Enter Discount Code" value="{{ old('discount_code') }}" required>
                                                        @error('discount_code')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="datetime-local" name="expiration_date" id="expiration_date" 
                                                            class="form-control" value="{{ old('expiration_date') }}" required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="max_redemptions_per_user" id="max_redemptions_per_user" required
                                                            class="form-control" placeholder="Enter No of Redeem Per User" value="{{ old('max_redemptions_per_user') }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="max_uses" id="max_uses" class="form-control" 
                                                            placeholder="Enter Total No of Redeem" value="{{ old('max_uses') }}" required>
                                                        @error('max_uses')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
