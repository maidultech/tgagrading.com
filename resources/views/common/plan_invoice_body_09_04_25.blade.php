                    ...
                    <table class="table m-0 min_width ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- <td class="text-end">{{ getDefaultCurrencySymbol() }}{{ number_format(($setting->gst_tax*$total_amount/100),2) }}</td> --}}
                            ...
                            <tr>
                                ...
                                {{-- <td class="text-end">{{ getDefaultCurrencySymbol() }}{{ number_format(($setting->pst_tax*$total_amount/100),2) }}</td> --}}
                            </tr>
                            @if ($trnx->order->used_wallet > 0)
                                <tr>
