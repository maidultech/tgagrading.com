                    ...
                    <table class="table m-0 min_width ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- <td class="text-end">{{ getDefaultCurrencySymbol() }}{{ number_format(($trnx->order->gst_tax*$total_amount/100),2) }}</td> --}}
                                <td class="text-end">
                            ...
                            <tr>
                                ...
                                {{-- <td class="text-end">{{ getDefaultCurrencySymbol() }}{{ number_format(($trnx->order->pst_tax*$total_amount/100),2) }}</td> --}}
                                <td class="text-end">
                                    {{ getDefaultCurrencySymbol() }}
