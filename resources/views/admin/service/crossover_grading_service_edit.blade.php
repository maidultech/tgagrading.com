                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <h3 class="card-title"> Edit Crossover Card Grading</h3>
                                    </div>
                                    <div class="col-6">
                            ...
                            <div class="card-body table-responsive p-4">
                                <form action="{{ route('admin.service.update', $service->id) }}" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <h4 class="mt-3">What is Crossover Grading?</h4>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="sf_details" id="sf_details" class="summernote" class="form-control"
                                                    placeholder="Enter sb details">{{ old('sf_details', $service->serviceExtra?->sf_details) }}</textarea>
                                            </div>
                                        </div>

                                        <div class="col-lg-4">
                                            <h4 class="mt-3">Why Choose Us for Crossover Grading?</h4>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="sg_details" id="sg_details" class="summernote" class="form-control"
                                                    placeholder="Enter sc details">{{ old('sg_details', $service->serviceExtra?->sg_details) }}</textarea>
                                            </div>
                                        </div>
                                    </div>

                                    <h4 class="mt-3">What to Consider Before Choosing Our Crossover Grading?</h4>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label for="sb_main_title" class="form-lable">Section Title</label>
                                            <input type="text" name="sb_main_title" id="sb_main_title"
                                                value="{{ old('sb_main_title', $service->sb_main_title) }}"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="sa_details" class="form-lable">Section Details</label>
                                            <textarea type="text" name="sa_details" id="sa_details" class="summernote" class="form-control"
                                                placeholder="Enter details">{{ old('sa_details', $service->sa_details) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <h5 class="mt-3">Scenario 1</h5>
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="sc_details" id="sc_details" class="summernote" class="form-control"
                                                    placeholder="Enter sc details">{{ old('sc_details', $service->sc_details) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <h4 class="mt-3">Regular vs Express Crossover</h4>
                                    {{-- <div class="col-lg-4">
                                        <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sd_title" id="sd_title"
                                                    ...
                                                    class="form-control" placeholder="Enter your sd title">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="sd_details" id="sd_details" class="summernote" class="form-control"
                                                    placeholder="Enter sd details">{{ old('sd_details', $service->sd_details) }}</textarea>
                                            </div>
                                        </div>

                                        <div class="col-lg-4">
                                            <h5 class="mt-3">Express</h5>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="se_details" id="se_details" class="summernote" class="form-control"
                                                    placeholder="Enter se details">{{ old('sc_details', $service->se_details) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="schema_markup" id="schema_markup" class="form-control"
                                                    placeholder="Enter Schema Markup Code">{{ old('schema_markup', $service->schema_markup ?? '<script> </script>') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
