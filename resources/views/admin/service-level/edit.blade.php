                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row justify-content-center">
                                    <form class="col-md-8" action="{{ route('admin.service.level.update', $row->id) }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" min="0" name="estimated_days" id="estimated_days" class="form-control" value="{{ old('estimated_days',$row->estimated_days, 0) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6 input-group">
                                                ...
                                                <input type="number" min="0" name="extra_price" id="extra_price" class="form-control" value="{{ old('extra_price',$row->extra_price, 0) }}" required>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" min="1" name="order_id" id="order_id" class="form-control" value="{{ old('order_id',$row->order_id) }}">
                                            </div>
                                        </div>
