...
<!-- ======================= TGA Grading start  ============================ -->
@if ($service->se_img)
    <div class="how_it_work_section custom-text-bullet py-5 bg-light">
        <div class="container mt-3">
            <div class="row gy-5 align-items-center mb-4">
                <div class="col-md-7">
                    <div class="pe-xl-5">
                        <div class="section_heading mt-4 mb-3" style="margin-top: -30px">
                            <h2 class="mb-0"> {{ $service->se_title }}</h2>
                        </div>

                        <p class="mb-3"> {!! nl2br($service->se_details) !!} </p>
                        @if (@$service->se_link)
                            <a href="{{ $service->se_link }}" class="btn btn-primary px-3 py-2">Submit card grading</a>
                        @endif
                    </div>
                </div>
                <div class="col-md-5">
                    ...
                    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                                <img src="{{ asset($service->se_img) }}" class="d-block w-100 carousel-img"
                                    alt="...">
                            </div>
                        </div>
                    </div>
...
@if ($service->sa_img)
    <div class="container-fluid">
        <div class="section_heading text-center">
            ...
            <p>
                {{ $service->sub_title ?? null }}
            </p>
        </div>
    </div>
    <div class="how_it_work_section custom-text-bullet py-2">
        <div class="container mt-3">
            <div class="row gy-5 align-items-center mb-4">
                <div class="col-md-5">
                    {{-- <h6 class="fw-semibold text-center mb-2"> Recently Graded </h6> --}}
                    ...
                    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                                <img src="{{ asset($service->sa_img) }}" class="d-block w-100 carousel-img"
                                    alt="...">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-7">
                    <div class="pe-xl-5">
                        <div class="section_heading mt-4 mb-3" style="margin-top: -30px">
                            <h3 class="mb-0"> {{ $service->sa_title }}</h3>
                        </div>

                        <p class="mb-3"> {!! nl2br($service->sa_details) !!} </p>
                        @if (@$service->sa_link)
                            <a href="{{ $service->sa_link }}" class="btn btn-primary px-3 py-2">Submit card grading</a>
                        @endif
                    </div>
                </div>
        ...
        <div class="container mt-3">
            <div class="row gy-5 align-items-center mb-4">
                <div class="col-md-7">
                    <div class="pe-xl-5">
                        <div class="section_heading mt-4 mb-3" style="margin-top: -30px">
                            <h3 class="mb-0"> {{ $service->sb_title }}</h3>
                        </div>

                        <p class="mb-3"> {!! nl2br($service->sa_details) !!} </p>
                        @if (@$service->sb_link)
                            <a href="{{ $service->sb_link }}" class="btn btn-primary px-3 py-2">Submit card grading</a>
                        @endif
                    </div>
                </div>
                <div class="col-md-5">
        ...
        <div class="container mt-3">
            <div class="row gy-5 align-items-center mb-4">
                ...
                <div class="col-md-7">
                    <div class="pe-xl-5">
                        <div class="section_heading mt-4 mb-3" style="margin-top: -30px">
                            <h3 class="mb-0"> {{ $service->sc_title }}</h3>
                        </div>

                        <p class="mb-3"> {!! nl2br($service->sa_details) !!} </p>
                        @if (@$service->sc_link)
                            <a href="{{ $service->sc_link }}" class="btn btn-primary px-3 py-2">Submit card
                                grading</a>
                        @endif
                    </div>
                </div>
        ...
        <div class="container mt-3">
            <div class="row gy-5 align-items-center mb-4">
                <div class="col-md-7">
                    <div class="pe-xl-5">
                        <div class="section_heading mt-4 mb-3" style="margin-top: -30px">
                            <h3 class="mb-0"> {{ $service->sd_title }}</h3>
                        </div>

                        <p class="mb-3"> {!! nl2br($service->sa_details) !!} </p>
                        @if (@$service->sd_link)
                            <a href="{{ $service->sd_link }}" class="btn btn-primary px-3 py-2">Submit card
                                grading</a>
                        @endif
                    </div>
                </div>
                <div class="col-md-5">
                    ...
                    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                                <img src="{{ asset($service->sd_img) }}" class="d-block w-100 carousel-img"
                                    alt="...">
                            </div>
                        </div>
                    </div>
...
@if (@$serviceExtra->sf_img || @$serviceExtra->sg_img || @$serviceExtra->sh_img)
            ...
            <div class="row g-4 g-lg-5 align-items-start">
                <div class="col-lg-5 d-none d-lg-inline-block">
                    <div class="tab-content img-tab-content" id="slabImageTab">
                        ...
                        @endif
                        @if ($serviceExtra->sh_img)
                            <div class="tab-pane fade" id="img-back" role="tabpanel">
                                <div class="slab-image">
                                    <img class="img-fluid" src="{{ asset($serviceExtra->sh_img) }}" alt="">
                                </div>
                            </div>
                        @endif
                    </div>
                ...
                <div class="col-lg-7">
                    <div class="py-lg-3 py-xl-5">
                        <h2 class="mb-4"> {{ $serviceExtra->extra_title }} </h2>
                        ...
                        <ul class="nav nav-pills mb-3 border p-2 rounded-pill" id="slabTab" role="tablist"
                            ...
                            @endif
                            @if ($serviceExtra->sh_title)
                                <li class="nav-item me-2" role="presentation">
                                    <button class="nav-link rounded-pill px-3 px-xl-4 py-1" data-bs-toggle="pill"
                                        data-bs-target="#back" type="button" role="tab">
                                        {{ $serviceExtra->sh_title }}
                                    </button>
                                </li>
                            @endif
                        </ul>
