                        ...
                        <div class="header mb-4">
                            <div class="title">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="">
                                        <a href="{{ route('user.ticket.create') }}" class="btn btn-light p-2 px-3">Create Ticket</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                @foreach($tickets as $ticket)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif --}}
                                            <span class="d-inline-flex  px-2 fw-semibold text-warning-emphasis bg-warning-subtle border border-warning-subtle rounded-2">{{ucfirst($ticket['status'])}}</span>
                                        </td>
                                        <td>
                                            {{-- @php
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($ticket['created_at'])->format('jS M, Y') }}</td>
                                        <td>
                                            @php
                                        ...
                                        <td>
                                            <a href="{{ route('user.ticket.show',['id' => $ticket['id']]) }}" title="View">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    stroke="#ffcc00" fill="none" stroke-linecap="round"
