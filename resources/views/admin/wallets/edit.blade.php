...
@section('title'){{ $data['title'] ?? 'Edit Wallet Transaction' }} @endsection
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <h3 class="card-title">Edit Wallet Transaction</h3>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-md-5">
                                        <form action="{{ route('admin.wallet.update', $transaction->id) }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="description" class="form-control" rows="3" placeholder="Enter description">{{ $transaction->description }}</textarea>
                                            </div>
