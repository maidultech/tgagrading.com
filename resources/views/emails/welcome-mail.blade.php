...
<head>
    ...
    <title>Welcome to {{ $setting->site_name }}</title>
    <style>
        /* Base ------------------------------ */
                    ...
                    <tr>
                        <td class="email-masthead">
                            <a href="{{ URL::to('/') }}" class="f-fallback email-masthead_name">
                                <img src="{{ config('app.url') }}/assets/order_email_logo.png" alt="{{config('app.name')}}" style="max-width: 150px; height: 40px;"> 
                            </a>
                        </td>
                    </tr>
                    <!-- Email Body -->
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <p>{{ __('Thanks for signing up to') }} {{ $setting->site_name }}!</p>
                                            <!-- Action -->
                                            <p>{{ __('If you have any questions about this, please visit our website') }}
                                                <a href="{{ URL::to('/') }}">TGAGrading.com</a>
                                            </p>
                                            {{-- <p>{{ __('Simply go here') }} <a
                                                    href="{{ URL::to('/') }}/login">{{ $setting->site_name }}</a> {{ __('to get
                                                started create a vCard.') }}</p> --}}
                                            <p style="margin: 0.4em 0 0.1875em !important;">Marcus</p>
                                                ...
                                                <tr>
                                                    <td>
                                                        <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; color: #b0adc5; font-size: 12px; text-align: center;">
                                                            © {{date('Y')}} {{$setting->site_name}}. {{ __('All rights reserved') }}.
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table>
