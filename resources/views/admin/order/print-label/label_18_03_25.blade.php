...
<body>
    ...
    <div class="mini_card position-relative overflow-hidden">
        <div class="row align-items-center justify-content-center w-100 d-flex"
            ...
            <div class="col-5" style="margin-left: 4px">
                ...
                @endif
                <div class="watermark_logo position-relative" style="{{ $cert->details?->notes || $cert->notes ? 'top: 1px;' : 'top: -5px;' }}">
                    ...
                    <div class="" style="padding: 0px 5px;">
                        <div class="card_info" style="width:50%; float:left; position: relative;{{ $cert->details?->notes || $cert->notes ? 'bottom:-5px' : 'bottom:-1.1rem' }}; {{getTitleStyle(($cert->details->card ?? $cert->card), 'position')}}">
                            <div class="gradings">
                        ...
                        <div class="card_info" style="width:50%; float:right; position: relative; text-align: right; left: {{ $grading_condition ? '24px' : '23px' }}; {{ $cert->details?->notes || $cert->notes ? 'bottom:-5px' : 'bottom:-1.1rem' }}; {{getTitleStyle(($cert->details->card ?? $cert->card), 'position')}}">
                            <div class="gradings">
            ...
            <div class="col-4" style="margin-left: 0px;">
                <div style="text-align: right !important;">
                    ...
                    @endphp
                    <div class="gem_num"
                        style="{{ $cert->details?->notes || $cert->notes ? '' : 'top: 3px;' }} @if (is_numeric($cert->final_grading) && strpos($cert->final_grading, '.5') !== false) 
                            font-size: 60px; transform: scale(.67, 1.05); @else font-size: 60px; transform: scale(1, 1.05); @endif">
