            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6 text-center">
                    <div>
                        ...
                        {{-- <img src="{{ asset('frontend/assets/images/thumbnail.png') }}" alt="Banner Image"
                            class="img-fluid rounded-4 shadow"
                            style="max-height: 400px; object-fit: cover; width: 100%;"> --}}
                    </div>
                </div>
            ...
            <div class="row gy-5 mt-3 align-items-center">
                <div class="col-md-7">
                    <div class="pe-xl-5">
                        ...
                        <p class="mb-3">{!! nl2br($service->sa_details ?? '') !!}
                        </p>
                        @if (@$service->asking_link)
                            <a href="{{ $service->asking_link }}" class="btn btn-primary px-4 py-2">Submit Card
                                Grading</a>
                        @endif
                    </div>
                </div>
                <div class="col-md-5">
                    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <a href="{{ $service->asking_link }}">
                                <div class="carousel-item active" data-bs-interval="10000">
                                    <div class="row justify-content-center">
                                        <img src="{{ asset($service->sa_img) }}" style="width: 320px"
...
<!-- ======================= Additional carousel section - Start ============================ -->
@if ($services->count() > 3)
...
@endif
<!-- ======================= Additional carousel section - End ============================ -->
                ...
                <div class="col-lg-5 d-none d-lg-inline-block">
                    <div class="tab-content img-tab-content" id="slabImageTab">
                        ...
                        @if ($serviceExtra->sf_img)
                            <div class="tab-pane fade" id="img-front2" role="tabpanel">
                                <div class="slab-image">
                                    <img class="img-fluid" src="{{ asset($serviceExtra->sf_img) }}" alt="">
                                </div>
                            </div>
                        @endif
                        @if ($serviceExtra->sg_img)
                            <div class="tab-pane fade" id="img-top2" role="tabpanel">
                                <div class="slab-image">
                                    <img class="img-fluid" src="{{ asset($serviceExtra->sg_img) }}" alt="">
                                </div>
                            </div>
                        @endif
                    </div>
                ...
                <div class="col-lg-7">
                    <div class="py-lg-3 py-xl-5">
                        ...
                        <ul class="nav nav-pills mb-3 border p-2 rounded-pill" id="slabTab" role="tablist"
                            ...
                            @endif
                            @if ($serviceExtra->sf_title)
                                <li class="nav-item me-2" role="presentation">
                                    <button class="nav-link rounded-pill px-3 px-xl-4 py-1" data-bs-toggle="pill"
                                        data-bs-target="#front2" type="button" role="tab">
                                        {{ $serviceExtra->sf_title }}
                                    </button>
                                </li>
                            @endif
                            @if ($serviceExtra->sg_title)
                                <li class="nav-item me-2" role="presentation">
                                    <button class="nav-link rounded-pill px-3 px-xl-4 py-1" data-bs-toggle="pill"
                                        data-bs-target="#top2" type="button" role="tab">
                                        {{ $serviceExtra->sg_title }}
                                    </button>
                                </li>
                            @endif
                        </ul>
                        ...
                        <div class="tab-content custom-text-bullet" id="slabTabContent">
                            ...
                            <div class="tab-pane fade" id="front2" role="tabpanel" data-bs-target="#img-front2">
                                {!! nl2br($serviceExtra->sf_details ?? '') !!}
                            </div>
                            <div class="tab-pane fade" id="top2" role="tabpanel" data-bs-target="#img-top2">
                                {!! nl2br($serviceExtra->sg_details ?? '') !!}
                            </div>
                        </div>
                    </div>
                </div>
...
{{-- Static multi tab section --}}
<div class="container custom-text-bullet">
    <div class="section_heading text-center mb-2">
        <h2> Grading Subgrades and Criteria </h2>
        <p>
            To provide clarity and the highest quality, we evaluate each of the four criteria and give a detailed
            sub-score. Here are the sub-grades of a few words about each of them:
        </p>
    </div>
...
<div class="our-graded-pokemon-card py-5">
    <div class="container">
        <div class="row g-4 g-lg-5 align-items-start">
            <div class="col-lg-5 d-none d-lg-inline-block">
                <div class="tab-content img-tab-content" id="conditionImageTab">
                    <div class="tab-pane fade show active" id="img-centering" role="tabpanel">
                        <div class="slab-image">
                            <img class="img-fluid" src="{{ asset('assets/images/tab/centering.jpg') }}"
                                alt="">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="img-surface" role="tabpanel">
                        <div class="slab-image">
                            <img class="img-fluid" src="{{ asset('assets/images/tab/surface.jpg') }}"
                                alt="">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="img-corners" role="tabpanel">
                        <div class="slab-image">
                            <img class="img-fluid" src="{{ asset('assets/images/tab/corners.jpg') }}"
                                alt="">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="img-edges" role="tabpanel">
                        <div class="slab-image">
                            <img class="img-fluid" src="{{ asset('assets/images/tab/edges.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7">
                <div class="py-lg-3 py-xl-5">
                    ...
                    <ul class="nav nav-pills mb-3 border p-2 rounded-pill" id="conditionTab" role="tablist"
                        style="display: inline-flex">
                        <li class="nav-item me-2" role="presentation">
                            <button class="nav-link active rounded-pill px-3 px-xl-4 py-1" data-bs-toggle="pill"
                                data-bs-target="#centering" type="button" role="tab">
                                Centering
                            </button>
                        </li>
                        ...
                        <li class="nav-item me-2" role="presentation">
                            <button class="nav-link rounded-pill px-3 px-xl-4 py-1" data-bs-toggle="pill"
                                data-bs-target="#corners" type="button" role="tab">
                                Corners
                            </button>
                        </li>
                        ...
                        <li class="nav-item me-2" role="presentation">
                            <button class="nav-link rounded-pill px-3 px-xl-4 py-1" data-bs-toggle="pill"
                                data-bs-target="#edges" type="button" role="tab">
                                Edges
                            </button>
                        </li>
                    </ul>

                    <div class="tab-content custom-text-bullet" id="conditionTabContent">
                        <div class="tab-pane fade show active" id="centering" role="tabpanel"
                            data-bs-target="#img-centering">
                            This looks at how balanced the card is on all its sides, or in other words, if every part of
                            the card has the same amount of whitespace around it. Even a tiny ” off ” focus from here
                            will result in an undesired level of gradation
                        </div>
                        <div class="tab-pane fade" id="surface" role="tabpanel" data-bs-target="#img-surface">
                            If the surface of the card is brightly colored and has no print lines, which are the result
                            of the cards being placed in a foil sheet in a waxed box, and has no scratches (surface
                            scratches are the worst for card keepers), marks, or damage, then it is in good condition.
                            Although "first humans" can be okay on revised stuff in general, the absence of surface
                            scratches indicates that the box was used only one or two times and thus did not damage the
                            card. The edges and back are processed in the same way, and each process has a scale.
                        </div>
                        <div class="tab-pane fade" id="corners" role="tabpanel" data-bs-target="#img-corners">
                            Known as the toughest part of the card to keep perfect through its lifetime, we are looking
                            for:
                            <ul>
                                <li>Pointiness</li>
                                <li>Bends</li>
                                <li>Any hint of white/metal that has started to come through Stamped</li>
                            </ul>
                            It should go without mention that pointy corners are a requirement of 9s, 9.5s, and 10s (a
                            10 corner on a black-bordered 9.5 means 20 points)
                        </div>
                        <div class="tab-pane fade" id="edges" role="tabpanel" data-bs-target="#img-edges">
                            The edges of a card should look clean and sharp. There should be no signs of chipping,
                            fraying, or tiny cuts along the border. If you see any white spots, rough edges, or damage,
                            the grade will go down. Dark borders make edge flaws easier to spot, so they must be extra
                            clean. Smooth, sharp edges are key to getting a high score.
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container custom-text-bullet">
    <div class="section_heading text-center mb-2">
        <h2> {{ $service->asking_title ?? null }} </h2>
        <p>
            {!! nl2br($service->serviceExtra?->sh_details ?? null) !!}
        </p>
    </div>
...
<div class="how_it_work_section py-5 mb-5">
    <div class="container">
        <div class="section_heading text-center mb-5">
            <h2>{{ $home->hw_heading ?? 'How Our Card Grading Process Works' }}</h2>
