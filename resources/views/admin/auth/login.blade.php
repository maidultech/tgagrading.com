                        ...
                        <div class="signin_form p-3  p-md-5 bg-white">
                            <div class="mb-5 text-center">
                                <a href="{{ route('frontend.index') }}">
                                    <img src="{{ getLogo($setting->site_logo) }}" width="150" alt="logo">
                                </a>
                            </div>
                            ...
                            <div class="text-center"> <a href="{{ route('frontend.index') }}" class="m-2 p-2" style="display: block">{{ __('messages.nav.home') }}</a></div>
                        </div>
                    </form>
