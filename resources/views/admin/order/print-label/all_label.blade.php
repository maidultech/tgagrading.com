    ...
    @foreach ($certs as $index => $cert)
        ...
        <div class="mini_card position-relative overflow-hidden" style="@if ($avg_grade == 10) background: #000000; @else background: #ffffff; @endif">
            <div class="row align-items-center justify-content-center w-100 d-flex"
                ...
                <div class="col-5">
                    <div class="watermark_logo position-relative {{ $uniqueClass }}" style="{{
                        ...
                        <div class="card_title" style="padding: 0px 5px;{{getTitleStyle(($cert->details->card ?? $cert->card), 'fontsize')}} @if ($avg_grade == 10) color: #ffffff; @else color: #000000; @endif">
                ...
                <div class="col-4">
                    <div class="" style="text-align: right !important;">
                        <div class="logo_qr">
                            ...
                            @else 
                            {!! QrCode::size(50)->style('round')->color(0, 0, 0)->backgroundColor(255, 255, 255, 0)->generate(
                                route('frontend.certification', [
                                    'number' => $cert->card_number,
                                ]),
                            ) !!}
