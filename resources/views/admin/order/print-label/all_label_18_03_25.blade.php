        ...
        <div class="mini_card position-relative overflow-hidden" style="@if ($avg_grade == 10) background: #000000; @else background: #ffffff; @endif">
            <div class="row align-items-center justify-content-center w-100 d-flex"
                ...
                <div class="col-5" style="margin-left: 4px">
                    ...
                    @endif
                    <div class="watermark_logo position-relative {{ $uniqueClass }}" style="{{ $cert->details?->notes || $cert->notes ? 'top: 1px;' : 'top: -5px;' }}">
                        ...
                        <div class="" style="padding: 0px 5px;">
                            <div class="card_info" style="width:50%; float:left; position: relative; @if ($avg_grade == 10) color: #ffffff; @else color: #000000; @endif
                                {{ $cert->details?->notes || $cert->notes ? 'bottom:-5px' : 'bottom:-1.1rem' }}; {{getTitleStyle(($cert->details->card ?? $cert->card), 'position')}}">
                              <div class="gradings">
                            ...
                            <div class="card_info" style="width:50%; float:right; position: relative; text-align: right; left: {{ $grading_condition ? '24px' : '23px' }}; @if ($avg_grade == 10) color: #ffffff; @else color: #000000; @endif
                                {{ $cert->details?->notes || $cert->notes ? 'bottom:-5px' : 'bottom:-1.1rem' }}; {{getTitleStyle(($cert->details->card ?? $cert->card), 'position')}}">
                               <div class="gradings">
                ...
                <div class="col-4" style="margin-left: 0px;">
                    <div style="text-align: right !important;">
                        ...
                        @endphp
                            <div class="gem_num"
                                style="{{ $cert->details?->notes || $cert->notes ? '' : 'top: 3px;' }} @if ($avg_grade == 10) color: #ffffff; @else color: #000000; @endif 
