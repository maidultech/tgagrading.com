        ...
        <div class="col-md-6">
            ...
            <div class="form-group w-100">
                ...
                <select class="form-control form-select" name="shipping_method">
                    ...
                    @if($order->rUser?->local_pickup == 1)
                        <option value="local_pickup" @selected($order->shipping_method=='local_pickup')>Local Pickup</option>
                    @endif
                    <option value="other" @selected(!in_array($order->shipping_method, ['canada_post','ups','local_pickup']))>Other</option>
                </select>
            </div>
        </div>
           ...
           <div class="card">
                <div class="card-body "  >
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        {{-- <small>please fillup additional charge </small> --}}
                        <button type="button" class="btn btn-sm btn-primary" id="addRowBtn"> <i class="fa-solid fa-plus"></i> add</button>
                    </div>
                    <div id="chargesContainer">
                         @foreach($charges as $charge)
            <div class="row mb-2 charge-row">
                <div class="col-md-6 mt-1">
                    <input type="text" class="form-control" name="details[]" value="{{ $charge->details }}" placeholder="Details">
                </div>
                <div class="col-md-5 mt-1">
                    <input type="number" class="form-control" name="price[]" value="{{ $charge->price }}" placeholder="Amount" step="any">
                </div>
