                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.plan.store') }}" class="pt-3 pb-3">
                                    @csrf
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="is_badge" id="is_badge" class="form-control" required>
                                                            ...
                                                            <option value="popular" {{ old('is_badge') == 'popular' ? 'selected' : '' }}>Most Popular</option>
                                                            <option value="custom" {{ old('is_badge') == 'custom' ? 'selected' : '' }}>Custom</option>
                                                            <option value="none" {{ old('is_badge') == 'none' ? 'selected' : '' }}>No</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-6" id="custom_text_container" style="display: none;">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="custom_text" id="custom_text" placeholder="Custom Badge Text"
                                                               class="form-control" value="{{ old('custom_text') }}">
                                                    </div>
                                                </div>
                                                {{-- <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="type" id="type" class="form-control">
                                                            <option value="single"
                                                                {{ old('type') == 'single' ? 'selected' : '' }}>
                                                                Single</option>
                                                            <option value="general"
                                                                {{ old('type') == 'general' ? 'selected' : '' }}>
                                                                General</option>
                                                            <option value="bulk"
                                                                {{ old('type') == 'bulk' ? 'selected' : '' }}>
                                                                Bulk</option>
                                                            <option value="subscription"
                                                                {{ old('type') == 'subscription' ? 'selected' : '' }}>
                                                                Subscription</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="subscription_year" id="subscription_year" min="1"
                                                                    ...
                                                                    value="{{ old('subscription_year') }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="subscription_peryear_card" class="form-label">Number of Cards <span class="text-danger">*</span></label>
                                                                <input type="number" name="subscription_peryear_card" min="1" id="subscription_peryear_card"
                                                                    placeholder="Number of Cards" class="form-control"
                                                                    value="{{ old('subscription_peryear_card') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="">
                                                            <div class="">
                                                                <label for=""
                                                                    class="form-label">{{ __('messages.plan.feature') }}
                                                                </label>
                                                                <input type="text" name="feature_name[]"
                                                                    id="feature_name" class="form-control"
                                                                    placeholder="{{ __('messages.plan.feature') }}"
                                                                    value="{{ old('feature_name.0') }}">
                                                            </div>
                                                        </div>
...
@push('script')
    <script>
        $(document).ready(function() {
            $('body').on('click', '.addMoreFeature', function() {
                var input = `
                   <div class="col-6 externalField mb-4">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const subscriptionFields = ['subscription_year', 'subscription_peryear_card', 'minimum_card'];
