                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        ...
                        <p><strong>Destination:</strong> 
                            {{$trackingDetails['packageAddress'][0]['address']['city']}},
                            {{$trackingDetails['packageAddress'][0]['address']['stateProvince']}},
                            {{$trackingDetails['packageAddress'][0]['address']['country']}},
                            {{$trackingDetails['packageAddress'][0]['address']['countryCode']}}
                        </p>
                        <p><strong>Delivery Status:</strong> <span title="{{ $trackingDetails['currentStatus']['simplifiedTextDescription'] }}">{{$trackingDetails['currentStatus']['description']}}</span></p>

                        <p><strong>Expected Delivery:</strong> @if(isset($trackingDetails['deliveryDate'][0])){{ \Carbon\Carbon::parse($trackingDetails['deliveryDate'][0])->format('F j, Y') }}@endif</p>
