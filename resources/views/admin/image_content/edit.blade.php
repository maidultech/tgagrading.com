                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="row py-4 px-3 justify-content-center">
                            <div class="col-md-6">
                                <form method="POST" action="{{ route('admin.image-content.update', $row->id) }}"
                                    enctype="multipart/form-data">
                                    @csrf

                                    <div class="mb-3">
                                        <label for="up_name" class="form-label">Image Content Name <span
                                                class="text-danger">*</span></label>
                                        <input name="name" id="up_name" placeholder="Write Image Content Name"
                                            type="text" class="form-control" value="{{ $row->name }}" required>
                                    </div>

                                    <div class="mb-3">
                                        <img src="{{ asset($row->image) }}" class="d-block" alt="Image Content Image"
                                            for="up_image" style="width: 75px; height: 75px;">
                                        <label class="form-label">Image Content Image <span class="text-danger">*
                                                Recommendation ( 100px X 100px )</span></label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="link" id="link" placeholder="Write Image Content Link" type="url"
                                            class="form-control" value="{{ $row->link }}">
                                    </div>
                                    <div class="mb-3">
